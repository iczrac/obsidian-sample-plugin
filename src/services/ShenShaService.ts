...
export class ShenShaService {
   ...
   * @returns 神煞的详细信息
   */
  public static getShenShaInfo(shenSha: string): { name: string; type: string; explanation: string; influence: string; calculation?: string } | null {
    // 移除可能的前缀（如"年柱:"）
    const cleanName = shenSha.includes(':') ? shenSha.split(':')[1] : shenSha;
    const explanations: { [key: string]: { name: string; type: string; explanation: string; influence: string; calculation?: string } } = {
      '天乙贵人': {
        name: '天乙贵人',
        type: '吉神',
      ...
      '文曲': {
        name: '文曲',
        type: '吉神',
        explanation: '文曲星主文学才华，利于文学创作、艺术表达。',
        influence: '有文曲星的人，文学才华出众，适合从事文学创作、艺术表达等工作，容易在文学艺术领域取得成就。',
      ...
      '解神': {
        name: '解神',
        type: '吉神',
        explanation: '解神主解除和化解，能够解除困境和阻碍，化解灾难。',
        influence: '有解神的人，能够解除困境和阻碍，化解灾难，逢凶化吉，遇难呈祥，事业发展顺利。',
      ...
      '红鸾': {
        name: '红鸾',
        type: '吉凶神',
        explanation: '红鸾主婚姻和姻缘，利于婚姻和感情，但也容易因感情而烦恼。',
        influence: '有红鸾的人，婚姻和感情运势好，容易遇到良缘，但也容易因感情而烦恼，需要注意感情问题。',
        calculation: '红鸾查法：<br>以年支查红鸾：<br>子年红鸾在酉，丑年红鸾在申，寅年红鸾在未，卯年红鸾在午<br>辰年红鸾在巳，巳年红鸾在辰，午年红鸾在卯，未年红鸾在寅<br>申年红鸾在丑，酉年红鸾在子，戌年红鸾在亥，亥年红鸾在戌'
      },
      '天姚': {
        name: '天姚',
        type: '吉凶神',
        explanation: '天姚主感情和桃花，利于感情但也容易因感情而烦恼。',
        influence: '有天姚的人，感情丰富，异性缘好，但也容易因感情而烦恼，需要注意感情问题。',
      ...
      '童子煞': {
        name: '童子煞',
        type: '凶神',
        explanation: '童子煞主命格中带有童子命格特征，容易导致婚姻不顺，子女缘薄，健康不佳等问题。',
        influence: '有童子煞的人，婚姻容易不顺，子女缘薄，健康容易出现问题，需要注意婚姻和健康问题。',
      ...
      '将军箭': {
        name: '将军箭',
        type: '凶神',
        explanation: '将军箭是一种严重的童年关煞，主幼年多灾多难，容易导致孩童夭折或重病。',
        influence: '有将军箭的人，幼年容易多灾多难，健康容易出现问题，需要特别注意健康和安全问题。',
      ...
      '天赦': {
        name: '天赦',
        type: '吉神',
        explanation: '天赦主宽恕和赦免，能够得到宽恕和赦免，逢凶化吉。',
        influence: '有天赦的人，能够得到宽恕和赦免，逢凶化吉，遇难呈祥，事业发展顺利。',
      ...
      '天恩': {
        name: '天恩',
        type: '吉神',
        explanation: '天恩主恩惠和恩典，能够得到恩惠和恩典，逢凶化吉。',
        influence: '有天恩的人，能够得到恩惠和恩典，逢凶化吉，遇难呈祥，事业发展顺利。',
      ...
      '天官': {
        name: '天官',
        type: '吉神',
        explanation: '天官主官运和贵人，能够得到官运和贵人相助，事业有成。',
        influence: '有天官的人，官运好，容易得到贵人相助，事业有成，容易获得地位和权力。',
   ...
   * @returns 神煞的详细解释
   */
  public static getShenShaExplanation(shenSha: string): { name: string; type: string; explanation: string; influence: string; calculation?: string } {
    // 移除可能的前缀（如"年柱:"）
    const cleanName = shenSha.includes(':') ? shenSha.split(':')[1] : shenSha;
